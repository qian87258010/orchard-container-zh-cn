...
然后下载 Release 附件中的 `Xingyizhu-Container-1.12.1-zh.3-macos-arm64.zip`，解压后把 `星奕筑容器.app` 放入 `/Applications`。
...
```text
1756c4ac480ac45f70b8e1892a25cb90adaa928233d5823d0aca97b3b781b596  Xingyizhu-Container-1.12.1-zh.3-macos-arm64.zip
```
